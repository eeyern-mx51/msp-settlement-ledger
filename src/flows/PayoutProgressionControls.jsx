...
const SCENARIOS = [
  ...
  { scenario: "Bank holiday — don't want transfers going out", level: "global", outcome: "FinOps Admin turns off auto-transfer for the day. Payouts can still be prepared and approved, just won't execute." },
...
const AUTOMATION_STEPS = [
  ...
  { step: "Transfer", auto_on: "System auto-initiates transfer once approved", auto_off: "FinOps manually clicks \"Execute\" (current POC behaviour)", who: "FinOps Admin only" },
];
