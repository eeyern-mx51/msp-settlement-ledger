        ...
        <div className="mt-6 bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>{[
              ...
              ["2", "Ready for Review", "Ready for Transfer", "Approve", "Manual", "Toby reviews and approves"],
              ["3", "Ready for Review", "Completed", "Zero/neg balance", "Auto", "Debt deferred \u2014 no transfer needed"],
              ["4", "Ready for Review", "Abandoned", "Abandon", "Manual", "Toby cancels before approval"],
              ["5", "Ready for Transfer", "Transferring", "Begin transfer", "Manual/Auto", "NPP transfer initiated"],
              ["6", "Ready for Transfer", "Abandoned", "Abandon", "Manual", "Toby cancels before execution"],
