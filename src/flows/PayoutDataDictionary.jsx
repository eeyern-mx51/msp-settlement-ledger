    ...
    items: [
      ...
      },
      {
        ...
        rules: [
          ...
          { rule: "Retry transitions to Ready for Transfer", detail: "When a retry is initiated, the payout status changes from Failed to Ready for Transfer. FinOps must then Execute the transfer as a separate step. This maintains the two-step (approve → execute) control flow.", futureAutomation: false },
