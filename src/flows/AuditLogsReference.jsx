...
const events = [
  ...
  { phase: "abandon", n: 20, event: "Abandoned (from Ready for Transfer)", trigger: "FinOps Administrator", triggerType: "finops", sBefore: "Ready for Transfer", sAfter: "Abandoned", scBefore: "transfer", scAfter: "abandoned", user: "Sarah Chen (FinOps Administrator)", audit: "Payout abandoned. Reason: Duplicate payout detected.", toast: "Payout abandoned — Transactions returned to ledger." },
  { phase: "abandon", n: 21, event: "Abandoned (from Failed)", trigger: "FinOps Administrator", triggerType: "finops", sBefore: "Failed", sAfter: "Abandoned", scBefore: "failed", scAfter: "abandoned", user: "Tom Wright (FinOps Administrator)", audit: "Payout abandoned. Reason: Merchant account closed.", toast: "Payout abandoned — Transactions returned to ledger." },
