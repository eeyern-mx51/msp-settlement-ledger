...
const events = [
  ...
  // Happy path
  { phase: "happy", n: 3, event: "Payout prepared", trigger: "Toby", triggerType: "finops", sBefore: "Pre-prepared", sAfter: "Ready for Review", scBefore: "pre", scAfter: "review", user: "System", audit: "Merchant balance swept. 32 transactions included across 2 DTE files. Payout amount: $2,051.80.", toast: "Payouts prepared — 1 new payout prepared and set to Ready for Review." },
  ...
  { phase: "happy", n: 5, event: "Approved", trigger: "Toby", triggerType: "finops", sBefore: "Ready for Review", sAfter: "Ready for Transfer", scBefore: "review", scAfter: "transfer", user: "Tom Wright (Toby)", audit: "Payout reviewed and approved. Status changed to Ready for Transfer.", toast: "Payout approved — PO-2026-0224-001 is now ready for transfer." },
  { phase: "happy", n: 6, event: "Transfer initiated", trigger: "Toby", triggerType: "finops", sBefore: "Ready for Transfer", sAfter: "Transferring", scBefore: "transfer", scAfter: "transferring", user: "Tom Wright (Toby)", audit: "Payout submitted to banking network for settlement.", toast: "Transfer initiated — Payout PO-2026-0224-001 is now transferring." },
  ...
  // Hold — payout level
  { phase: "hold", n: 9, event: "Hold placed (payout)", trigger: "Toby", triggerType: "finops", sBefore: "Any non-terminal", sAfter: "Same + On Hold", scBefore: "same", scAfter: "hold", user: "Sarah Chen (Toby)", audit: "Hold placed. Reason: Suspicious activity review.", toast: "Hold placed — PO-2026-0224-001 — Suspicious activity review." },
  ...
  { phase: "hold", n: 11, event: "Hold released (payout)", trigger: "Toby", triggerType: "finops", sBefore: "Same + On Hold", sAfter: "Same (hold removed)", scBefore: "hold", scAfter: "same", user: "Tom Wright (Toby)", audit: "Hold released. Payout resumes from Ready for Transfer.", toast: "Hold released — Hold on PO-2026-0224-001 has been released." },

  // Hold — merchant level
  { phase: "hold", n: 12, event: "Merchant hold placed", trigger: "Toby", triggerType: "finops", sBefore: "Any non-terminal", sAfter: "Same + On Hold", scBefore: "same", scAfter: "hold", user: "Tom Wright (Toby)", audit: "All payouts for Joe's Coffee - Sydney CBD placed on hold.", toast: "All payouts for Joe's Coffee are now on hold." },
  { phase: "hold", n: 13, event: "Merchant hold released", trigger: "Toby", triggerType: "finops", sBefore: "Same + On Hold", sAfter: "Same (hold removed)", scBefore: "hold", scAfter: "same", user: "Tom Wright (Toby)", audit: "Merchant-level hold released for Joe's Coffee - Sydney CBD.", toast: "Payouts for Joe's Coffee can now proceed." },

  // Hold — fleet level
  { phase: "hold", n: 14, event: "Fleet hold placed", trigger: "Toby", triggerType: "finops", sBefore: "Any non-terminal", sAfter: "Same + On Hold", scBefore: "same", scAfter: "hold", user: "Tom Wright (Toby)", audit: "All fleet payouts placed on hold. Reason: Regulatory compliance review.", toast: "Fleet hold placed — All fleet payouts are now on hold." },
  { phase: "hold", n: 15, event: "Fleet hold released", trigger: "Toby", triggerType: "finops", sBefore: "Same + On Hold", sAfter: "Same (hold removed)", scBefore: "hold", scAfter: "same", user: "Tom Wright (Toby)", audit: "Fleet-level hold released. All payouts can now proceed.", toast: "Fleet hold released — All fleet payouts can now proceed." },
  ...
  { phase: "failure", n: 18, event: "Payout resubmitted", trigger: "Toby", triggerType: "finops", sBefore: "Failed", sAfter: "Ready for Transfer", scBefore: "failed", scAfter: "transfer", user: "Tom Wright (Toby)", audit: "Payout resubmitted for transfer. Moved back to Ready for Transfer.", toast: "Payout resubmitted — PO-2026-0220-001 moved to Ready for Transfer." },

  // Abandon
  { phase: "abandon", n: 19, event: "Abandoned (from Ready for Review)", trigger: "Toby", triggerType: "finops", sBefore: "Ready for Review", sAfter: "Abandoned", scBefore: "review", scAfter: "abandoned", user: "Tom Wright (Toby)", audit: "Payout abandoned. Reason: Merchant requested payout deferral.", toast: "Payout abandoned — Transactions returned to ledger." },
  { phase: "abandon", n: 20, event: "Abandoned (from Ready for Transfer)", trigger: "Toby", triggerType: "finops", sBefore: "Ready for Transfer", sAfter: "Abandoned", scBefore: "transfer", scAfter: "abandoned", user: "Sarah Chen (Toby)", audit: "Payout abandoned. Reason: Duplicate payout detected.", toast: "Payout abandoned — Transactions returned to ledger." },
  { phase: "abandon", n: 21, event: "Abandoned (from Failed)", trigger: "Toby", triggerType: "finops", sBefore: "Failed", sAfter: "Abandoned", scBefore: "failed", scAfter: "abandoned", user: "Tom Wright (Toby)", audit: "Payout abandoned. Reason: Merchant account closed.", toast: "Payout abandoned — Transactions returned to ledger." },
  { phase: "abandon", n: 22, event: "Transactions returned to ledger", trigger: "System", triggerType: "system", sBefore: "—", sAfter: "Abandoned", scBefore: "", scAfter: "abandoned", user: "System", audit: "Payout abandoned. Transactions returned to ledger for next payout preparation.", toast: "" },

  // Adjustments
  { phase: "adjustment", n: 23, event: "Manual adjustment created", trigger: "Toby", triggerType: "finops", sBefore: "Any", sAfter: "Same", scBefore: "same", scAfter: "same", user: "Tom Wright (Toby)", audit: "Adjustment ADJ-2026-0225-001 for -$125.00 created. Status: Pending Approval.", toast: "Adjustment created — pending approval." },
  { phase: "adjustment", n: 24, event: "Adjustment approved", trigger: "Toby", triggerType: "finops", sBefore: "Pending Approval", sAfter: "Approved", scBefore: "pending", scAfter: "approved", user: "Sarah Chen (Toby)", audit: "Adjustment approved. Will be included in next payout.", toast: "Adjustment approved — ADJ-2026-0225-001." },
  { phase: "adjustment", n: 25, event: "Adjustment rejected", trigger: "Toby", triggerType: "finops", sBefore: "Pending Approval", sAfter: "Rejected", scBefore: "pending", scAfter: "rejected", user: "Sarah Chen (Toby)", audit: "Adjustment rejected. Reason: Investigation found amounts correct.", toast: "Adjustment rejected — ADJ-2026-0222-002." },
  ...
  // Edge cases
  { phase: "edge", n: 28, event: "Multiple DTE files in single prep", trigger: "Toby", triggerType: "finops", sBefore: "Pre-prepared", sAfter: "Ready for Review", scBefore: "pre", scAfter: "review", user: "System", audit: "Payout prepared from 5 accumulated DTE files spanning 23–25 Feb. Total: 58 txns, $4,892.15.", toast: "" },
